export const ZZNFTABI = [
    ...
    },
    {
        ...
        name: "_mintedCountsPublicSecond",
        outputs: [
            {
                internalType: "uint256",
                name: "",
    ...
    {
        inputs: [],
        name: "maxPublicMintSecondLimitPerAddr",
        outputs: [
            {
                internalType: "uint256",
                name: "",
    ...
    {
        inputs: [],
        name: "maxWhitelistMintLimitPerAddr",
        outputs: [
            {
                internalType: "uint256",
                name: "",
