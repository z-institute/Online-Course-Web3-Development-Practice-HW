...
contract NFT is Ownable, ERC721A, EIP712 {
    ...
    uint256 public constant mintPriceSecond = 0.001 ether;
    ...
    address public constant reserver = 0x0278137e8E2C38111297c9991815507eB16eaf25;
    ...
    /// @dev Verify voucher
    function verify(NFTVoucher calldata voucher, bytes calldata signature, address to) public view returns (string memory) {
