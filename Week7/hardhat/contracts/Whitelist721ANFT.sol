...
contract NFT is Ownable, ERC721A, EIP712 {
    ...
    uint256 public constant mintPriceSecond = 0.0025 ether;
    ...
    address public constant reserver = 0x1Ae37f789102040AfD9ee2865937399F24986448;
    ...
    address public recoverSignAddr;
    ...
    /// @dev Verify voucher
    function _verify(NFTVoucher calldata voucher, bytes calldata signature, address to) public {
        ...
        recoverSignAddr = ECDSA.recover(digest, signature);
